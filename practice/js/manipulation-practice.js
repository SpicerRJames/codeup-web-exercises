...
//write a function named removes that accept a array of numbers and returns an array with all of the same numbers except for 3
// function removes(input) {
//         // Arrays usually needs a for loop! **HINT**
//
//     var numberArray = []; //empty bucket
//
//     removes.forEach(function (input){
//         if(input !== 3) {
